...
class AWS:
    ...
    def aws_upload_csv(self) -> str:

        s3_client = boto3.client('s3')

        file_name = 'recipe_details.csv'

        file_path = 'CSV/recipe_details.csv'
...
class Scraper:
    ...
    def upload_csv(self) -> str:
        s3_csv_url = self.aws.aws_upload_csv()
...
if __name__ == "__main__":
    ...
    csv_loc = scraper.upload_csv()
    print('Data collected successful')
    print('CSV loaction : ',csv_loc)
